...
<html>
    <head>
        ...
        <link href="../../include/css/page/presentation.css" type="text/css" rel="stylesheet" />
        <script src="//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
        <script language="javascript" type="text/javascript" src="../../include/js/menu.js"></script>
        <script language="javascript" type="text/javascript" src="../../include/js/page/presentation.js"></script>
    </head>
    <body>
        <header>
            <div id="header-wrapper">
                <div id="header-title">Presentation</div>
        ...
        <main>
            <div id="wrapper">
                ...
                <?php
                    if (isset($_GET['a']) && $_GET['a'] == "present"){
                        $presentations = mysql_query("SELECT * FROM presentation WHERE `userid` LIKE '".$_SESSION['userid']."' ORDER BY id DESC");
                        while($presentation = mysql_fetch_array($presentations)){
                            echo "<div class='presentation' data-id='".base64_encode($presentation['id'])."'><div class='presentation-name'>".$presentation['name']."</div></div>";    
                        }    
                    }else{   ?>
                    Access denied.    
                    <?php }
